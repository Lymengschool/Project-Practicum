        ...
        <div className={menu.container}>
            <div className={menu.menublock}>
                ...
                <div className={`${menu.innerright} ${activeButton === 1 ? menu.active : menu.none}`}>
                    <button><span>30 វិ.</span></button>
                    <button><span>60 វិ.</span></button>
                    <button><span>90 វិ.</span></button>
                    <button><span>120 វិ.</span></button>
                    <button>
                        <span>
                ...
                <div className={`${menu.innerright} ${activeButton === 2 ? menu.active : menu.none}`}>
                    <button><span>ខ្លី</span></button>
                    <button><span>មធ្យម</span></button>
                    <button><span>វែង</span></button>
                </div>

                <div className={`${menu.innerright} ${activeButton === 4 ? menu.active : menu.none}`}>
                    <button><span>ផ្លាស់ប្តូ</span></button>
                </div>
